 ...
 * (OIF_110)
 */
public class SoapParam110 
{
	@Getter
	private String elementKey = "getUsernameListByPartyAlternate";
	@Getter @Setter
	private String mobileNo;
	
	private SoapConnUtil soapConnUtil;
	public SoapParam110(SoapConnUtil soapConnUtil) {
	 ...
	 */
	public SoapResponse110 execute() throws Exception
	{
		...
		soapConnUtil.makeParam(soapBodyElem, SoapConnUtil.NAMESPACE_MAIN, "username", mobileNo);

		SOAPMessage response = SoapConnUtil.call(soapConnUtil.soapEpUrlDataRetrieval, soapMessage);
		
		return new SoapResponse110(response);
	}
}
