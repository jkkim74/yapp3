...
public abstract class YappSoapKosResponse 
{
	private static final Logger logger = LoggerFactory.getLogger(YappSoapKosResponse.class);

	@Getter	/** 반환코드 */
	protected String rtnCd;
	
	@Getter	/** 반환타입 */
	protected String respTp;
	
	@Getter	/** 성공여부 */
	protected String sucesYn;
	...
	{
//		this.sucesYn = getNodeText("KEY_VALUE_01_SBST");
//		this.rtnCd = getNodeText("KEY_VALUE_02_SBST");
