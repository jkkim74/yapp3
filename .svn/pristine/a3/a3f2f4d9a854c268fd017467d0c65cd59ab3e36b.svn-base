 ...
 */
public class SoapResponseRetrieveDrctlyUseQntDtl extends YappSoapKosResponse
{
	...
	public SoapResponseRetrieveDrctlyUseQntDtl(SOAPMessage response) throws Exception {
