 ...
 * (OIF_107)
 */
public class SoapParam107 
{
	@Getter
	private String elementKey = "authenticateUserByIdPwd";
	@Getter @Setter
	...
	public SoapParam107(SoapConnUtil soapConnUtil) {
	 ...
	 */
	public SoapResponse107 execute() throws Exception
	{
		...
		soapConnUtil.makeParam(soapBodyElem, SoapConnUtil.NAMESPACE_MAIN, "domain_name_cd", "2");	// 올레 서비스 계약

		SOAPMessage response = SoapConnUtil.call(soapConnUtil.soapEpUrlAuth, soapMessage);
		
		return new SoapResponse107(response);
	}
}
