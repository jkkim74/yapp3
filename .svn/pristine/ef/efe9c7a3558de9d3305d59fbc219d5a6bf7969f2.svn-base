 ...
 * KOS 내 데이터 상세 정보
 */
public class SoapParamRetrieveDrctlyUseQntDtl2 
{
	@Getter @Setter	/** 계약번호 */
	...
	public SoapParamRetrieveDrctlyUseQntDtl2(SoapConnUtil soapConnUtil) {
	 ...
	 */
	public SoapResponseRetrieveDrctlyUseQntDtl2 execute() throws Exception
	{
		...
		return new SoapResponseRetrieveDrctlyUseQntDtl2(response);
	}
}
