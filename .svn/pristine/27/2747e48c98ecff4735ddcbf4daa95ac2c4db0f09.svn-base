 ...
 * (OIF_133)
 */
public class SoapParam133 
{
	@Getter
	private String elementKey = "getBasicMobileInfoRequest";
	@Getter @Setter
	private String mobileNo;
	
	private SoapConnUtil soapConnUtil;
	public SoapParam133(SoapConnUtil soapConnUtil) {
	 ...
	 */
	public SoapResponse133 execute() throws Exception
	{
		...
		soapConnUtil.makeParam(soapBodyElem, SoapConnUtil.NAMESPACE_MAIN, "Phone_Number", mobileNo);

		SOAPMessage response = SoapConnUtil.call(soapConnUtil.soapEpUrlDataRetrieval, soapMessage);
		
		return new SoapResponse133(response);
	}
}
